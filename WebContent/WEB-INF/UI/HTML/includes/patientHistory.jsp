...
<div class="pull-right col-md-3">
	...
	<ul class="conversations">
		<li>
			<h4 class="media-sub-heading counselor_name">Prashant <small> 31st July - 6pm</small></h4>
			Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin bus.
		</li>
		<li>
			<h4 class="media-sub-heading counselor_name">Shahrukh<small> 31st July - 6pm</small></h4>
			Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. us.
		</li>
	</ul>
</div>
