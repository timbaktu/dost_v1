			  ...
			  <div class="nav-collapse navbar-collapse ">
				<ul class="nav navbar-nav pull-right ">
					<sec:authorize ifNotGranted="ROLE_USER">
						<li style="display:none"><a href="login" class="btn btn-primary btn-large login_now">LOGIN</a></li>
						<li style="display:none"><a href="signupNow" class="btn btn-primary btn-large signup_now">SIGNUP NOW</a></li>
					</sec:authorize>
				...
				<ul class="nav navbar-nav pull-left menuItems">
				  <sec:authorize access="hasRole('ROLE_USER')">
					<li style="display:none" id="conversations"><a href="conversations">My Conversations</a></li>
				  </sec:authorize>
				  <li style="display:none" id="discussions"><a href="forums/show/1.page">Discussions</a></li>
				  <sec:authorize access="hasRole('ROLE_USER')">
				  	<li style="display:none" id="talkToFriend"><a href="talkToFriend">Talk To a Friend</a></li>
				  </sec:authorize>
				  <li id="faqs"><a href="faqs">FAQs</a></li>
				  <li style="display:none" id="quotes"><a href="quotes">Quotes</a></li>
