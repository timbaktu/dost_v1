...
define(['handlebars-orig', 'moment', 'underscore-string'], function(Handlebars, moment, _s) {
    ...
    /**
     * This helper provides the difference between current date and the given date.
     * 
	 * date is the date to parse and format
	 * 
     * Usage: <span>{{getDateDiff myDate}}</span>
     */
    Handlebars.registerHelper('getDateDiff', function(dateString) {
    	if(!dateString){
    		return "";
    	}
